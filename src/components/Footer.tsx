  ...
  return (
    <>
      ...
      {showModal && (
        ...
        >
          <div 
            className="bg-[#FFFFFF] border border-[#E7E5E1] rounded-[10px] md:rounded-[12px] p-6 md:p-7 max-w-sm md:max-w-md w-full shadow-xl text-left"
            onClick={(e) => e.stopPropagation()}
          >
            <span className="text-[11px] md:text-[12px] font-semibold tracking-wider text-[#6B7280] uppercase">
              Companion App
            </span>
            <h3 className="text-[18px] md:text-[20px] font-[650] text-[#14181F] mt-1 mb-2">
              Sahyog Citizen Portal
            </h3>
            <p className="text-[13.5px] md:text-[14px] text-[#6B7280] leading-relaxed mb-5">
            ...
            <div className="flex gap-2">
              <button
                onClick={() => setShowModal(false)}
                className="w-full h-11 md:h-12 bg-[#1F4D3D] hover:bg-[#173C2F] text-white font-[600] text-[14px] rounded-[8px] transition-colors"
              >
