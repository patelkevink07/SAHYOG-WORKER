        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-5 border-b border-[#E7E5E1]">
          ...
          <div className="space-y-2 w-full sm:w-56 md:w-64 text-[12px] text-[#6B7280]">
            <div className="flex items-center gap-2">
              ...
              <span className="w-8 text-right tabular-nums font-[500]">94%</span>
            </div>
            <div className="flex items-center gap-2">
              ...
              <span className="w-8 text-right tabular-nums font-[500]">5%</span>
            </div>
            <div className="flex items-center gap-2">
              ...
              <span className="w-8 text-right tabular-nums font-[500]">1%</span>
            </div>
          </div>
        </div>
